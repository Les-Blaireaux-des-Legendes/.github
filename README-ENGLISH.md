...
> *“Driven by curiosity, rigor, and a taste for complex investigations, we trace information wherever it hides — and sometimes where it has not yet appeared.”*
...
**Founded:** 2024  
**Legal status:** French non-profit association (Law 1901)  
**Domain:** Open Source Intelligence (OSINT) · Cyber Investigation · Digital Forensics  

The Legendary Badgers began as an informal collective of cybersecurity and intelligence practitioners and evolved into a structured association to formalize operations and reinforce methodological rigor.

Beyond competitive OSINT, the group contributes to **public-interest digital investigations**, including:
- Countering online misinformation
- Supporting victims of cyberharassment
- Monitoring harmful or illicit online content (including child exploitation-related threats)
- Promoting safer digital environments

> The name is a cultural reference to a French espionage universe, reflecting a core intent:  
> **make intelligence work accessible without sacrificing rigor.**
...
- Participate in OSINT CTFs, missing persons investigations, and intelligence challenges
- Develop advanced methodologies in digital investigation, cyber intelligence, and data analysis
- Maintain continuous monitoring of tools, techniques, and threat landscapes

## Knowledge & Impact
- Promote ethical and responsible OSINT practices
- Democratize investigative techniques through gamification and education
- Strengthen francophone visibility in global cybersecurity communities

## Integrity & Safety
- Combat misinformation and digital abuse
- Support cyberharassment victims
- Contribute to safer information ecosystems

---

# 🌐 — Operational Doctrine (“The Burrow”)

Recruitment is **closed by design**.
...
The collective prioritizes:
- Depth over scale
- Stability over expansion
- Expertise over volume

We operate as a **flat, collaborative intelligence cell**, where:
- Responsibility is distributed
- Communication is fluid
- Trust is operational currency

## 🤝 External Cooperation
We collaborate with aligned actors through:
- Joint investigations
- Tool testing and experimentation
- Knowledge exchange
...
Reserve contributors provide **mission-based support capacity**, activated depending on operational needs.

Recruitment is strictly **sponsorship-based** to ensure alignment with collective values.
...
## 🎖 Veterans
Former operators who significantly contributed to past missions continue to play an important indirect role. Although no longer in active service, they remain part of an informal intelligence network. Through this network, they contribute valuable contextual insight, helping to clarify complex situations with the benefit of experience. They also provide analytical feedback, offering critical perspectives on strategies, decisions, and outcomes.

In addition, they preserve and transmit operational memory, ensuring that lessons learned from past missions are not lost over time but remain accessible to inform future actions :
...
## 🥇 Trace Labs OSINT Search Party CTF (2025)
- Global missing persons investigation competition
- 1st place worldwide (100+ teams)
- Gold Badge awarded

## 🥇 EGE CTF “HUNT” (2025)
- 1st place / 67 teams
- Final held in Paris (École de Guerre Économique)

## 🥇 HEXA OSINT CTF (2024)
- 1st place / 400+ participants
- Final at LeHACK (Paris)

## 🥉 Le Bruit des Bottes (2025)
- 3rd place / 219 teams
- High-complexity HUMINT simulation

## 🥈 Stranger Case OSINT (2024)
- 2nd place qualification

## 🥉 Stranger Case x HUNT OSINT (2024)
- 3rd place final

## 🧪 Capture The Evidence — French Gendarmerie 🇫🇷 (2024)
- 6th place / 170 teams
- Multi-domain forensic challenge (OSINT · reverse · crypto · AI)

---

# 🧠 — Challenge Engineering

We don’t only participate in intelligence simulations — we design them.

Our work focuses on:
- Narrative-driven investigative scenarios
- Information warfare simulations
- OSINT gamification systems
- Hybrid intelligence environments

## Notable productions

### 🛡️ Égide CTF (2025)
Co-designed for the French Ministry of Armed Forces, MEAE, and VIGINUM  
Focus: Information manipulation & cognitive resilience

### 🎯 Mission Vérité — Bpifrance CTF (2025)
Hybrid investigative simulation:
- Online OSINT phase
- Live final at Accor Arena (BIG event)

Participants followed a structured narrative requiring:
...
The badger is not symbolic — it is operational.

- Persistent under pressure  
- Methodical in execution  
- Adaptable across environments  
- Effective through endurance rather than force  

> “The surface misleads. Depth reveals.”
...
- Pro bono knowledge sharing
- Conferences & workshops
- OSINT training sessions

📬 Contact :  **lesblaireauxdeslegendes[@]proton.me**  
🔗 LinkedIn: https://www.linkedin.com/company/bdl-osint

---

> *“It is not instinct that makes the investigator — it is persistence… and sometimes a strong coffee at 2 AM.”*  
> — Field note, Badger Unit
