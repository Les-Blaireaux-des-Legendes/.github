...
Mais au-delà de l’image souvent caricaturale qui lui est associée, nous assumons et revendiquons le blaireau comme un symbole à réhabiliter. Casser le mythe du "blaireau", c’est justement reconnaître la valeur de ce qui est discret et persistant. Dans la forêt comme dans le cyberespace, la logique reste la même :
